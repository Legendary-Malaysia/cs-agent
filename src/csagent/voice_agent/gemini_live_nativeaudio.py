...
get_weather_vegas = {"name": "get_weather_vegas"}
tools = [{"function_declarations": [turn_on_the_lights, get_weather_vegas]}]
        ...
        while True:
            ...
            async for response in turn:
                ...
                if tool := response.tool_call:
                    function_responses = []
                    for fc in tool.function_calls:
                        # 1. Identify the function
                        if fc.name == "turn_on_the_lights":
                            print("Action: Turning on lights...")
                            # result = your_real_function()
                        ...
                        elif fc.name == "get_weather_vegas":
                            print("Action: Getting weather in Las Vegas...")
                        ...
                        # 2. Send the response back to the model
                        # Note: You MUST provide the call ID so the model knows which call this matches
